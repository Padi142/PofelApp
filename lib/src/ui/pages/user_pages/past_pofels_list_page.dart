...
class PastPofelsPage extends StatefulWidget {
  PastPofelsPage({Key? key}) : super(key: key);

  @override
  State<PastPofelsPage> createState() => _DashboardPageState();
}

class _DashboardPageState extends State<PastPofelsPage> {
  final myController = TextEditingController();
  @override
  Widget build(BuildContext context) {
    BlocProvider.of<LoadpofelsBloc>(context).add(LoadMyPastPofels());
    return Scaffold(
      body: SafeArea(
        child: Flex(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Align(
                  alignment: Alignment.centerLeft,
                  child: (Text("Pofely starší jak 4 dny se zobrazí tady",
